import s from './CommunityGallery.module.sass'
...
const CommunityGallery = () => {
    ...
    const saveHandler = () => {
        ...
        axiosAuth.post('/community/gallery/create', queryData)
            .then(({data})=> {
                setList([ data, ...list ])
    ...
    const deleteHandler = id => {
        ...
        axiosAuth.delete('/community/gallery/delete', { data: { id } })
            .then(()=> {
    ...
    const saveNewPosition = e => {
        ...
        axiosAuth.post('/community/gallery/position', { id, new_position })

...
const testData = [
    { id: 0, description: 'Зарегистрироваться на платформе', color: '#4B21B1' },
    { id: 1, description: 'Зарегистрироваться на платформе', color: '#4B21B1' },
    { id: 2, description: 'Зарегистрироваться на платформе', color: '#4B21B1' },
]
...
const TeachersClub = () => {
    ...
    return <>
        ...
        <section className={ s.container }>
            ...
            <TextInput label='Текст' className={ s.textInput }/>
